...
| **Prüfwerkzeuge** | `npm run checks` | **19 Gates in 38 s, 0 Verstöße** — und seit 2026-09-20 in der CI verdrahtet. Vorher lief in der Pipeline KEINES der 19 Werkzeuge (nur lint, test, e2e): Ein Gate, das niemand aufruft, ist eine Empfehlung |
